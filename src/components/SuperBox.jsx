function SuperBox() {
  return (
    <section className="flex justify-center items-center w-full min-h-48 pt-7.5 pb-3.75 mb-12 px-4">
      <div className="max-w-300 w-full min-h-39 bg-[url('https://www.kktcell.com/Files/Banners/Ana_Sayfa_Basvuru_Banner/superbox_ontalep__1_.png')] bg-cover bg-center rounded-2xl bg-no-repeat py-6">
        <div className="flex flex-col md:flex-row justify-between items-center h-full w-full text-white text-center md:text-left px-6 md:px-12 gap-6 md:gap-4">
