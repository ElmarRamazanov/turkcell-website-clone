  ...
  return (
    <section className="flex justify-center items-center  w-[1905px] h-48 pt-7.5 pb-3.75 mb-12">
        ...
        <div className="flex justify-between items-center h-full w-full text-white text-center px-12">
            ...
            <span className="text-sm">Evde, ofiste veya tatilde ayda 959 TL'den başlayan fiyatlarla</span>
            </div>
            <a href="" className="border-2 border-solid outline-white py-2 px-8 rounded-full font-bold mr-10">Başvur</a>
        </div>
        </div>
    </section>
  );
