...
const [activeLanguage, setActiveLanguage] = useState("tr");
  ...
  return (
    <footer className="flex flex-row w-full bg-[#2658AE] text-white border-t border-white py-3">
      <div className="container max-w-300 flex gap-x-4 items-start text-center mx-auto mt-3 pb-2 text-[15px] leading-[1.4]">
        <div
          className={`cursor-pointer border-b pb-0.5 ${
            activeLanguage === "tr" ? "border-[#FFD200]" : "border-transparent"
          }`}
        ...
        <div
          className={`cursor-pointer border-b pb-0.5 ${
            activeLanguage === "en" ? "border-[#FFD200]" : "border-transparent"
          }`}
